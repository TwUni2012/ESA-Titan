    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(esa.titan.soap.weatherservice.generated.GlobalWeather.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = esa.titan.soap.weatherservice.generated.GlobalWeather.class.getResource(".");
